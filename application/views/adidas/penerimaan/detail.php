                                ...
                                <div class="col-md-12"><br>
                                    ...
                                    <div class="col-md-4">
                                      <?php
                                        ...
                                        ?>
                                            <div class=" ">
                                                <label>1.</label>
                                                <input disabled type="checkbox" name ="test_required[]" id="household" value="Color Fastness to House Hold Laundering"
                                            ...
                                            <div class=" ">
                                                <label>2.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="water" value="Color Fastness to Water"
                                                 <?= in_array("Color Fastness to Water", $selected) ? 'checked':''?>>
                                                <label for="water">Color Fastness to Water*)</label>
                                            </div>
                                            <div class=" ">
                                                <label>3.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="perspiration" value="Color Fastness to Perspiration"
                                                 <?= in_array("Color Fastness to Perspiration", $selected) ? 'checked':''?>>
                                                <label for="perspiration">Color Fastness to Perspiration*)</label>
                                            </div>
                                            <div class=" ">
                                                <label>4.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="washing" value="Color Fastness to Washing"
                                                <?= in_array("Color Fastness to Washing", $selected) ? 'checked':''?>>
                                                <label for="washing">Color Fastness to Washing*)</label>
                                            </div>
                                            <div class=" ">
                                            <label>5.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="rubbing" value="Color Fastness to Rubbing"
                                                <?= in_array("Color Fastness to Rubbing", $selected) ? 'checked':''?>>
                                                <label for="rubbing">Color Fastness to Rubbing*)</label>
                                            </div>
                                            <div class=" ">
                                            <label>6.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="lightfastness" value="Color Fastness to Light Fastness"
                                                <?= in_array("Color Fastness to Light Fastness", $selected) ? 'checked':''?>>
                                                <label for="lightfastness">Color Fastness to Light Fastness*)</label>
                                            </div>
                                            <div class=" ">
                                            <label>7.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="fastnessperspiration" value="Color Fastness to Light Fastness Perspiration"
                                            ...
                                            <div class=" ">
                                            <label>8.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="phenolicyellowing" value="Color Fastness to Phenolic Yellowing"
                                            ...
                                            <div class=" ">
                                            <label>9.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="saliva" value="Color Fastness to Saliva"
                                                 <?= in_array("Color Fastness to Saliva", $selected) ? 'checked':''?>>
                                                <label for="saliva">Color Fastness to Saliva*)</label>
                                            </div>
                                            <div class=" ">
                                            <label>10.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="storage" value="Color Fastness Dye Transfer In Storage"
                                            ...
                                            <div class=" ">
                                            <label>11.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="migration" value="Color Migration Fastness"
                                                 <?= in_array("Color Migration Fastness", $selected) ? 'checked':''?>>
                                                <label for="migration">Color Migration Fastness</label>
                                            </div>
                                            <div class=" ">
                                            <label>12.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="oven" value="Color Migration Oven Test"
                                                <?= in_array("Color Migration Oven Test", $selected) ? 'checked':''?>>
                                                <label for="oven">Color Migration Oven Test</label>
                                            </div>
                                            <div class=" ">
                                            <label>13.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="chlorinated" value="Color Fastness to Chlorinated Water"
                                            ...
                                            <div class=" ">
                                            <label>14.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="seawater" value="Color Fastness to Sea Water"
                                                <?= in_array("Color Fastness to Sea Water", $selected) ? 'checked':''?>>
                                                <label for="seawater">Color Fastness to Sea Water</label>
                                            </div>
                                            <div class=" ">
                                            <label>15.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="chlorine" value="Color Fastness to Chlorine Bleach"
                                                <?= in_array("Color Fastness to Sea Water", $selected) ? 'checked':''?>>
                                                <label for="chlorine">Color Fastness to Chlorine Bleach</label>
                                            </div>
                                            <div class=" ">
                                            <label>16.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="non-chlorine" value="Color Fastness to Non-Chlorine Bleach"
                                            ...
                                            <div class=" ">
                                                <label>17.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="laundering" value="Dimensional Stability to Laundering"
                                            ...
                                            <div class=" ">
                                            <label>18.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="appereancechange" value="Appereance Change After Laundering"
                                            ...
                                            <div class=" ">
                                            <label>19.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="spirality" value="Spirality"
                                                <?= in_array("Spirality", $selected) ? 'checked':''?>>
                                                <label for="spirality">Spirality*)</label>
                                            </div>
                                            <div class=" ">
                                            <label>20.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="durability" value="Durability Test"
                                                <?= in_array("Durability Test", $selected) ? 'checked':''?>>
                                                <label for="durability">Durability Test</label>
                                            </div>
                                            <div class=" ">
                                            <label>21.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="wearingtest" value="Wearing Test"
                                                <?= in_array("Wearing Test", $selected) ? 'checked':''?>>
                                                <label for="wearingtest">Wearing Test</label>
                                            </div>
                                            <div class=" ">
                                            <label>22.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="cuttable" value="Cuttable Width"
                                                <?= in_array("Cuttable Width", $selected) ? 'checked':''?>>
                                                <label for="cuttable">Cuttable Width</label>
                                            </div>
                                            <div class=" ">
                                            <label>23.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="fabricweight" value="Fabric Weight"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class=" ">
                                            <label>24.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="productweigth" value="Product Weight"
                                                <?= in_array("Product Weight", $selected) ? 'checked' :'' ?>>
                                                <label for="productweight">Product Weight</label>
                                            </div>
                                            <div class=" ">
                                            <label>25.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="pieceweight" value="Piece Weight"
                                                <?= in_array("Piece Weight", $selected) ? 'checked' :'' ?>>
                                                <label for="pieceweight">Piece Weight</label>
                                            </div>
                                            <div class=" ">
                                            <label>26.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="bow" value="Bow and Skew"
                                                <?= in_array("Bow and Skew", $selected) ? 'checked' :'' ?>>
                                                <label for="bow">Bow and Skew</label>
                                            </div>
                                            <div class=" ">
                                            <label>27.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="shrinkage" value="Heat Shrinkage"
                                                <?= in_array("Heat Shrinkage", $selected) ? 'checked' :'' ?>>
                                                <label for="shrinkage">Heat Shrinkage</label>
                                            </div>
                                            <div class=" ">
                                            <label>28.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="flammability" value="Flammability"
                                                <?= in_array("Flammability", $selected) ? 'checked' :'' ?>>
                                                <label for="flammability">Flammability</label>
                                            </div>
                                            <div class=" ">
                                            <label>29.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="elongation" value="Elongation & Recovery"
                                                <?= in_array("Elongation & Recovery", $selected) ? 'checked' :'' ?>>
                                                <label for="elongation">Elongation & Recovery</label>
                                            </div>
                                            <div class=" ">
                                            <label>30.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="fiber" value="Fibre/Fuzz"
                                                <?= in_array("Fibre/Fuzz", $selected) ? 'checked' :'' ?>>
                                                <label for="fiber">Fibre/Fuzz</label>
                                            </div>
                                            <div class=" ">
                                            <label>31.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="ici" value="ICI Pilling Box"
                                                <?= in_array("ICI Pilling Box", $selected) ? 'checked' :'' ?>>
                                                <label for="ici">ICI Pilling Box*)</label>
                                            </div>
                                            <div class=" ">
                                            <label>32.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="martindale" value="Martindale Pilling"
                                                <?= in_array("Martindale Pilling", $selected) ? 'checked' :'' ?>>
                                                <label for="martindale">Martindale Pilling*)</label>
                                            </div>
                                            <div class=" ">
                                            <label>33.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="tumble" value="Random Tumble Pilling"
                                                <?= in_array("Random Tumble Pilling", $selected) ? 'checked' :'' ?>>
                                                <label for="tumble">Random Tumble Pilling</label>
                                            </div>
                                            <div class=" ">
                                            <label>34.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="snagging" value="Snagging (Snag Pod)"
                                                <?= in_array("Snagging (Snag Pod)", $selected) ? 'checked' :'' ?>>
                                                <label for="snagging">Snagging (Snag Pod)</label>
                                            </div>
                                            <div class=" ">
                                            <label>35.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="abrasion" value="Abrasion Resistance"
                                                <?= in_array("Abrasion Resistance", $selected) ? 'checked' :'' ?>>
                                                <label for="abrasion">Abrasion Resistance*)</label>
                                            </div>
                                            <div class=" ">
                                            <label>36.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="abrasionsock" value="Abrasion Sock"
                                                <?= in_array("Abrasion Sock", $selected) ? 'checked' :'' ?>>
                                                <label for="abrasionsock">Abrasion Sock</label>
                                            </div>
                                            <div class=" ">
                                            <label>37.</label>    
                                                <input disabled type="checkbox" name="test_required[]" id="pnematic" value="Bursting Pnematic"
                                                <?= in_array("Bursting Pnematic", $selected) ? 'checked' :'' ?>>
                                                <label for="pnematic">Bursting Pnematic*)</label>
                                            </div>
                                            <div class=" ">
                                            <label>38.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="Hydraulic" value="Bursting Hydraulic"
                                                <?= in_array("Bursting Hydraulic", $selected) ? 'checked' :'' ?>>
                                                <label for="Hydraulic">Bursting Hydraulic</label>
                                            </div>
                                            <div class=" ">
                                            <label>39.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="Burst" value="Ball Burst"
                                                <?= in_array("Ball Burst", $selected) ? 'checked' :'' ?>>
                                                <label for="Burst">Ball Burst</label>
                                            </div>
                                            <div class=" ">
                                            <label>40.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="textile" value="Textile Material Thickness Measurement"
                                            ...
                                            <div class=" ">
                                            <label>41.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="odour" value="Odour"
                                                <?= in_array("Odour", $selected) ? 'checked' :'' ?>>
                                                <label for="odour">Odour</label>
                                            </div>
                                            <div class=" ">
                                            <label>42.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="moisture" value="Moisture Content"
                                                <?= in_array("Moisture Content", $selected) ? 'checked' :'' ?>>
                                                <label for="moisture">Moisture Content</label>
                                            </div>
                                            <div class=" ">
                                            <label>43.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="acceleratedageing" value="Accelerated Ageing by Hydrolysis"
                                            ...
                                            <div class=" ">
                                            <label>44.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="residue" value="Residue & Ageing Test for Sticker"
                                                <?= in_array("Residue & Ageing Test for Sticker", $selected) ? 'checked' :'' ?>>
                                                <label for="residue">Residue & Ageing Test for Sticker</label>
                                            </div>
                                            <div class=" ">
                                            <label>45.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="force" value="Pull of Force"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <div class=" ">
                                            <label>46.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="seamstrengthe" value="Seam Slippage/Strength"
                                                <?= in_array("Seam Slippage/Strength", $selected) ? 'checked' :'' ?>>
                                                <label for="seamstrength">Seam Slippage/Strength</label>
                                            </div>
                                            <div class=" ">
                                            <label>47.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="seamwoven" value="Seam Slippage of Woven"
                                                 <?= in_array("Seam Slippage of Woven", $selected) ? 'checked' :'' ?>>
                                                <label for="seamwoven">Seam Slippage of Woven</label>
                                            </div>
                                            <div class=" ">
                                            <label>48.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="tearstrength" value="Tear Strength"
                                                <?= in_array("Tear Strength", $selected) ? 'checked' :'' ?>>
                                                <label for="tearstrength">Tear Strength</label>
                                            </div>
                                            <div class=" ">
                                            <label>49.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="Yarn" value="Yarn Strength"
                                                <?= in_array("Yarn Strength", $selected) ? 'checked' :'' ?>>
                                                <label for="Yarn">Yarn Strength</label>
                                            </div>
                                            <div class=" ">
                                            <label>50.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="TensileStrength" value="Tensile Strength"
                                                <?= in_array("Tensile Strength", $selected) ? 'checked' :'' ?>>
                                                <label for="TensileStrength">Tensile Strength</label>
                                            </div>
                                            <div class=" ">
                                            <label>51.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="TearForce" value="Tear Force"
                                                <?= in_array("Tear Force", $selected) ? 'checked' :'' ?>>
                                                <label for="TearForce">Tear Force</label>
                                            </div>
                                            <div class=" ">
                                            <label>52.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="ThreadCount" value="Thread Count"
                                                <?= in_array("Thread Count", $selected) ? 'checked' :'' ?>>
                                                <label for="ThreadCount">Thread Count</label>
                                            </div>
                                            <div class=" ">
                                            <label>53.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="WaterAbsorbency" value="Water Absorbency (Drop Test)"
                                                <?= in_array("Water Absorbency (Drop Test)", $selected) ? 'checked' :'' ?>>
                                                <label for="WaterAbsorbency">Water Absorbency (Drop Test)</label>
                                            </div>
                                            <div class=" ">
                                            <label>54.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="WickingHeight" value="Wicking Height"
                                                <?= in_array("Wicking Height", $selected) ? 'checked' :'' ?>>
                                                <label for="WickingHeight">Wicking Height</label>
                                            </div>
                                            <div class=" ">
                                            <label>55.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="Evaporation" value="Evaporation Rate"
                                                <?= in_array("Evaporation Rate", $selected) ? 'checked' :'' ?>>
                                                <label for="Evaporation">Evaporation Rate</label>
                                            </div>
                                            <div class="">
                                            <label>56.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="Repellency" value="Water Repellency (Spray Test)"
                                                <?= in_array("Water Repellency (Spray Test)", $selected) ? 'checked' :'' ?>>
                                                <label for="Repellency">Water Repellency (Spray Test)</label>
                                            </div>
                                            <div class=" ">
                                            <label>57.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="Waterproof" value="Waterproof (Hydrostatic)"
                                                 <?= in_array("Waterproof (Hydrostatic)", $selected) ? 'checked' :'' ?>>
                                                <label for="Waterproof">Waterproof (Hydrostatic)</label>
                                            </div>
                                            <div class=" ">
                                            <label>58.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="Permeability" value="Air Permeability"
                                                 <?= in_array("Air Permeability", $selected) ? 'checked' :'' ?>>
                                                <label for="Permeability">Air Permeability</label>
                                            </div>
                                            <div class=" ">
                                            <label>59.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="Content" value="Fibre Content"
                                                <?= in_array("Fibre Content", $selected) ? 'checked' :'' ?>>
                                                <label for="Content">Fibre Content*)</label>
                                            </div>
                                            <div class=" ">
                                            <label>60.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="oil" value="Oil Content"
                                                <?= in_array("Oil Content", $selected) ? 'checked' :'' ?>>
                                                <label for="oil">Oil Content</label>
                                            </div>
                                            <div class=" ">
                                            <label>61.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="ph" value="pH Value"
                                                <?= in_array("pH Value", $selected) ? 'checked' :'' ?>>
                                                <label for="ph">pH Value*)</label>
                                            </div>
                                            <div class=" ">
                                            <label>62.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="Formaldehyde" value="Formaldehyde"
                                                <?= in_array("Formaldehyde", $selected) ? 'checked' :'' ?>>
                                                <label for="Formaldehyde">Formaldehyde*)</label>
                                            </div>
                                            <div class=" ">
                                            <label>63.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="nickel" value="Nickel Test"
                                                 <?= in_array("Nickel Test", $selected) ? 'checked' :'' ?>>
                                                <label for="nickel">Nickel Test</label>
                                            </div>
                                            <div class=" ">
                                            <label>64.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="azo" value="Azo Dyes"
                                                <?= in_array("Azo Dyes", $selected) ? 'checked' :'' ?>>
                                                <label for="azo">Azo Dyes</label>
                                            </div>
                                            <div class=" ">
                                            <label>65.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="ap" value="APEO"
                                                <?= in_array("APEO", $selected) ? 'checked' :'' ?>>
                                                <label for="ap">APEO</label>
                                            </div>
                                            <div class=" ">
                                            <label>66.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="apeo" value="AP"
                                                <?= in_array("AP", $selected) ? 'checked' :'' ?>>
                                                <label for="apeo">AP</label>
                                            </div>
                                            <div class=" ">
                                            <label>67.</label>
                                                <input disabled type="checkbox" name="test_required[]" id="Phthalates" value="Phthalates"
                                            ...
                                            <div class=" ">
                                                ...
                                                <input disabled type="text" name="test_requiredother" class="form-control" value="<?= htmlspecialchars($penerimaan['test_required_other'] ?? '') ?>">
                                            </div>
                                        </div>
                                    </div>
