      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
               ...
               <li class="breadcrumb-item active">Add Size Category</li>
                </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-10" style="padding-bottom: 1%;">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form action = "<?php echo site_url('c_transaksi/tambahaksi_sizecategory'); ?>" method="post">
                      <div class="card-body">    
                        <div class="col-md-12">
                      ...
                      <div class="card-footer">
                          <div class="col-md-1">
                            <a href="<?=site_url('c_transaksi/index_sizecategory')?>" type="button" class="btn btn-block" style="background-color: #36454F;color: white;" >Back</a> 
                          </div>
                          <div class="col-md-10">
